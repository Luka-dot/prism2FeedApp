...
-- AddForeignKey
ALTER TABLE "_FeedToFeedTag" ADD FOREIGN KEY ("B") REFERENCES "FeedTag"("is") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_BundleToBundleTag" ADD FOREIGN KEY ("B") REFERENCES "BundleTag"("is") ON DELETE CASCADE ON UPDATE CASCADE;
